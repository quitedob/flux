    ...
    while True:
        if not single_eval:
            ...
            if not line:
                ...
                if "prompt" in updates and mod_and_upsampling_model is not None and mod_and_upsampling_model.test_txt(updates["prompt"]):
                    print(
                ...
                if "input_images" in updates:
                    ...
                    for image in updates["input_images"]:
                        if mod_and_upsampling_model is not None and mod_and_upsampling_model.test_image(image):
        ...
        try:
            ...
            with torch.no_grad():
                ...
                if cpu_offloading:
                    ...
                    if "klein" in model_name and mod_and_upsampling_model is not None:
